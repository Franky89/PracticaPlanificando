...
namespace Gestionfuentes.Controllers
{
    public class FuenteController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FuenteID,Nombre,temperatura,valoracion,latitud,longitud")] Fuente fuente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FuenteID,Nombre,temperatura,valoracion,latitud,longitud")] Fuente fuente)
        {
            if (ModelState.IsValid)
            {
